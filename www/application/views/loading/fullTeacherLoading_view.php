...
echo '<div class="control-group getInfoByChange">' .
 form_label('Виберіть кафедру: ', 'kafedra', $labelAttr)
 . '<div class="controls">' . form_dropdown('kafedra', $kafedra, 'kafedra') . '</div></div>';
...
echo '<div class="control-group">' .
 ...
 . '<div class="controls">' . form_dropdown('teacher', $teacher, 'teacher') . '</div></div>';
echo '<div class="control-group">' .
