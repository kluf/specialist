    ...
    <div class="row-fluid">
        ...
        <div class="span3">
            ...
            <ul id="accordion" class="menu nav nav-pills nav-stacked">
                ...
                <li class="for_dropdown"><a href="#"><i class=" icon-eye-open"></i> - навантаження для огляду</a>
                    <ul>
                ...
                <li class="for_dropdown"><a href="#"><i class="icon-edit"></i><i class="icon-trash"></i> - навантаження для редагування та видалення</a>
                    <ul>
                ...
                <li class="for_dropdown"><a href="#"><i class="icon-plus-sign"></i> - додати інформацію</a>
                    <ul>
