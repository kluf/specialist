            ...
            <img alt='160x120' data-src='holder.js/160x120' src='/img/student/".$content['img']."'>
                  ...
                  "<strong>№ заліковки(нової): </strong>".$content['zalik2']."<br>
                      <div class='forDelUpd'>
                        ...
                        <form  method='POST' action='/index.php/student_controller/removeStudent/'><input type='hidden' name='idn' value = '{$content['id']}'><button class='btn btn-danger' type='submit'>Видалити </button></form>
                      </div>
